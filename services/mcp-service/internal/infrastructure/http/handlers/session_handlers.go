...
func CreateMCPSession() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		logging.LogInfo(c.Request.Context(), nil, "Sessão MCP criada",
			logging.String("session_id", sessionID),
			logging.String("channel", req.Channel),
...
func CloseMCPSession() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		logging.LogInfo(c.Request.Context(), nil, "Sessão MCP fechada",
			logging.String("session_id", sessionID),
		)
...
func SendMessage() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		logging.LogInfo(c.Request.Context(), nil, "Mensagem processada",
			logging.String("session_id", sessionID),
			logging.String("message_id", messageID),
			logging.Int("tokens_used", response.TokensUsed),
		)
