...
import (
	...
	"github.com/direito-lux/process-service/internal/infrastructure/database"
	"github.com/direito-lux/process-service/internal/infrastructure/events"
	"github.com/direito-lux/process-service/internal/infrastructure/http"
...
// @version 1.0
// @description Direito Lux Process Microservice
...
func main() {
	...
	logger.Info("Parando Process Service...")
	...
	logger.Info("Process Service parado com sucesso")
}
