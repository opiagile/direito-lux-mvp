...
import (
	...
	"github.com/direito-lux/search-service/internal/infrastructure/database"
	"github.com/direito-lux/search-service/internal/infrastructure/events"
...
// @title searchservice Service API
// @version 1.0
// @description Direito Lux searchservice Microservice
...
func main() {
	...
	logger.Info("Iniciando searchservice Service",
	...
	logger.Info("Parando searchservice Service...")
	...
	logger.Info("searchservice Service parado com sucesso")
}
