...
// BaseEvent implementação base de Event
...
// TenantCreatedEvent evento de tenant criado
func NewTenantCreatedEvent(tenant *Tenant) Event {
	return &BaseEvent{
		Type:        "tenant.created",
...
// TenantUpdatedEvent evento de tenant atualizado
func NewTenantUpdatedEvent(tenantID string, changes map[string]interface{}, updatedBy string) Event {
	return &BaseEvent{
		Type:        "tenant.updated",
...
// TenantActivatedEvent evento de tenant ativado
func NewTenantActivatedEvent(tenantID, activatedBy string) Event {
	return &BaseEvent{
		Type:        "tenant.activated",
		AggregateID: tenantID,
		Timestamp:   time.Now(),
...
// TenantSuspendedEvent evento de tenant suspenso
func NewTenantSuspendedEvent(tenantID, reason, suspendedBy string) Event {
	return &BaseEvent{
		Type:        "tenant.suspended",
		AggregateID: tenantID,
		Timestamp:   time.Now(),
...
// TenantCanceledEvent evento de tenant cancelado
func NewTenantCanceledEvent(tenantID, reason, canceledBy string) Event {
	return &BaseEvent{
		Type:        "tenant.canceled",
		AggregateID: tenantID,
		Timestamp:   time.Now(),
